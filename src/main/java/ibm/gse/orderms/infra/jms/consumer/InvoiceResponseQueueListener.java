 ...
 */
@ApplicationScoped
public class InvoiceResponseQueueListener implements Runnable {
    ...
    private static final Logger log = Logger.getLogger(InvoiceResponseQueueListener.class);
    ...
    public void run() {
        ...
        try (JMSContext context = connectionFactory.createContext(Session.AUTO_ACKNOWLEDGE)) {
            JMSConsumer consumer = context.createConsumer(context.createQueue(System.getenv("INVOICE_RESPONSE_QUEUE")));
            while (true) {
